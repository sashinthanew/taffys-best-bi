...
const AdminDashboard = ({ user, onLogout }) => {
      ...
      const projectData = {
        ...
        supplier: {
          proformaInvoice: {
            ...
            creditNote: parseFloat(formData.creditNote) || 0,
            finalInvoiceAmount: parseFloat(formData.finalInvoiceAmount) || 0
          },
          advancePayment: {
            loanAmount: parseFloat(formData.loanAmount) || 0,
            paymentDate: formData.advancePaymentDate ? new Date(formData.advancePaymentDate) : null,
        ...
        buyer: {
          proformaInvoice: {
            ...
            invoiceDate: formData.buyerProformaInvoiceDate ? new Date(formData.buyerProformaInvoiceDate) : null,
          ...
          advancePayment: {
            ...
            date: formData.buyerAdvanceDate ? new Date(formData.buyerAdvanceDate) : null,
            reference: formData.buyerAdvanceReference
          },
          balancePayment: {
            twlReceived: parseFloat(formData.buyerBalanceTwlReceived) || 0,
            date: formData.buyerBalanceDate ? new Date(formData.buyerBalanceDate) : null,
  ...
  const handleEdit = (project) => {
    ...
    setFormData({
      ...
      creditNote: (project.supplier?.proformaInvoice?.creditNote || 0).toString(),
      finalInvoiceAmount: (project.supplier?.proformaInvoice?.finalInvoiceAmount || 0).toString(),
      loanAmount: (project.supplier?.advancePayment?.loanAmount || 0).toString(),
      ...
      supplierBalanceTotalPayment: (project.supplier?.balancePayment?.totalPayment || 0).toString(),
      supplierTotalAmount: (project.supplier?.summary?.totalAmount || 0).toString(),
      supplierCancelAmount: (project.supplier?.summary?.cancelAmount || 0).toString(),
      supplierSummaryBalancePayment: (project.supplier?.summary?.balancePayment || 0).toString(),
      ...
      buyerCreditNote: (project.buyer?.proformaInvoice?.creditNote || 0).toString(),
      buyerBankInterest: (project.buyer?.proformaInvoice?.bankInterest || 0).toString(),
      buyerFreightCharges: (project.buyer?.proformaInvoice?.freightCharges || 0).toString(),
      buyerTwlInvoiceAmount: (project.buyer?.proformaInvoice?.twlInvoiceAmount || 0).toString(),
      buyerFinalInvoiceAmount: (project.buyer?.proformaInvoice?.finalInvoiceAmount || 0).toString(),
      buyerCommission: (project.buyer?.proformaInvoice?.commission || 0).toString(),
      buyerAdvanceTwlReceived: (project.buyer?.advancePayment?.twlReceived || 0).toString(),
      buyerAdvanceBalanceAmount: (project.buyer?.advancePayment?.balanceAmount || 0).toString(),
      buyerAdvanceDate: project.buyer?.advancePayment?.date?.split('T')[0] || '',
      buyerAdvanceReference: project.buyer?.advancePayment?.reference || '',
      buyerBalanceTwlReceived: (project.buyer?.balancePayment?.twlReceived || 0).toString(),
      buyerBalanceDate: project.buyer?.balancePayment?.date?.split('T')[0] || '',
      buyerBalanceReference: project.buyer?.balancePayment?.reference || '',
      buyerTotalReceived: (project.buyer?.summary?.totalReceived || 0).toString(),
      buyerCancel: (project.buyer?.summary?.cancel || 0).toString(),
      buyerBalanceReceived: (project.buyer?.summary?.balanceReceived || 0).toString(),
      costingSupplierInvoiceAmount: (project.costing?.supplierInvoiceAmount || 0).toString(),
      costingTwlInvoiceAmount: (project.costing?.twlInvoiceAmount || 0).toString(),
      costingProfit: (project.costing?.profit || 0).toString(),
      costingInGoing: (project.costing?.inGoing || 0).toString(),
      costingOutGoing: (project.costing?.outGoing || 0).toString(),
      costingCalCharges: (project.costing?.calCharges || 0).toString(),
      costingOther: (project.costing?.other || 0).toString(),
      costingForeignBankCharges: (project.costing?.foreignBankCharges || 0).toString(),
      costingLoanInterest: (project.costing?.loanInterest || 0).toString(),
      costingFreightCharges: (project.costing?.freightCharges || 0).toString(),
