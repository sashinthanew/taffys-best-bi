...
console.log('Fixing auth route and middleware files...\n');
...
fs.writeFileSync(authPath, authRouteContent, 'utf8');
console.log(`✓ Fixed: ${authPath}`);

fs.writeFileSync(middlewarePath, middlewareContent, 'utf8');
console.log(`✓ Fixed: ${middlewarePath}`);

console.log('\n✅ Files fixed! Server should start now.');
